...
const PanCenterPage = () => {
  ...
  const panServices = [
    ...
    },
    {
      ...
      icon: Edit,
      description: "Update PAN card details",
    },
    {
      name: "PAN Reprint",
      icon: Printer,
      description: "Get new PAN card print",
    },
    {
  ...
  const faq = [
    ...
    },
    {
      ...
      answer: "Flexible operating hours from 9 AM to 7 PM, Monday to Saturday.",
    },
    {
...
Remarks: _____________________
    ...
    a.href = url;
    a.download = "PAN_Centre_Application_Form.txt";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-pink-50">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">PAN CENTRE</h1>
      ...
      {/* Hero Section */}
      <section className="relative pb-16 pt-20 bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Partner with UTIITSL (UTI Infrastructure Technology And Services
                Limited) to provide official PAN card services including new
                applications, corrections, reprints, and updates.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <div className="relative">
              ...
              >
                <img
                  src="/pen-center-banner.jpg"
                  alt="PAN Centre banner"
                ...
                <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-6 shadow-xl">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">7-15 Days</div>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-80 flex-shrink-0">
              <div className="bg-white rounded-2xl shadow-xl border border-purple-200 p-6 sticky top-8">
                <h3 className="text-xl font-bold text-gray-900 mb-6 border-b border-purple-200 pb-4">
                  PAN Services
                </h3>
                    ...
                    <button
                      ...
                      className={`w-full flex items-center space-x-3 py-4 px-4 rounded-xl transition-all duration-300 text-left group ${
                        activeTab === tab.id
                          ...
                          : "text-gray-600 hover:bg-purple-50 hover:text-purple-700 hover:shadow-md"
                      }`}
                    >
                      <div
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200">
                  ...
                  <button className="w-full mt-4 bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-3 px-4 rounded-xl font-semibold hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg">
                ...
                <div className="mt-4">
                  <button
                    // onClick={downloadForm}
                    className="w-full bg-gradient-to-r from-pink-500 to-purple-500 text-white py-4 px-4 rounded-xl font-semibold hover:from-pink-600 hover:to-purple-600 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg"
                  >
                    <Download className="w-5 h-5" />
                    <span>Download Application Form</span>
                  </button>
                ...
                >
                  <div className="bg-white rounded-2xl p-8 shadow-xl border border-purple-200">
                    ...
                    <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                      Authorized PAN Center providing PAN card services
                      including new applications, corrections, reprints, and
                      updates. Partner with UTIITSL to offer official PAN
                      services with government-approved rates.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                      ...
                      <div className="bg-gradient-to-r from-indigo-50 to-pink-50 rounded-xl p-6 border border-indigo-200">
                        <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center space-x-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <p className="text-gray-700">
                            3-day training program covering PAN application
                            process, document verification, and UTIITSL
                            software.
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-gray-700">
                            UTIITSL technical support, regular updates, and
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {panServices.map((service, index) => (
                        <motion.div
                          ...
                          className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200 hover:shadow-lg transition-all duration-300 group"
                        >
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-xl border border-purple-200">
                        ...
                        {Object.entries(commission).map(
                          ([service, commission], index) => (
                            <motion.div
                              ...
                              transition={{ duration: 0.6, delay: index * 0.1 }}
                              className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-4 border border-purple-200 hover:shadow-lg transition-all duration-300"
                            >
                    ...
                    <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-6 border border-pink-200">
                      <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center space-x-2">
                        ...
                        <span>Why Choose PAN Centre?</span>
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                          "Official Partner",
                    ...
                    <div className="mb-8">
                      ...
                      <div className="space-y-4">
                        {process.map((step, index) => (
                          ...
                          >
                            <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 shadow-lg">
                              {index + 1}
                            </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                        ...
                        <div className="bg-white rounded-xl p-4 border border-purple-200">
                          ...
                          <div className="text-gray-600">UTIITSL Approval</div>
                        </div>
                        <div className="bg-white rounded-xl p-4 border border-purple-200">
                          <div className="text-2xl font-bold text-purple-600">
                            2-3 Days
                      ...
                      <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl p-6 border border-teal-200">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-white rounded-lg p-4 border border-teal-200">
                            ...
                            <p className="text-gray-700">
                              PAN application process, document verification,
                              and UTIITSL software
                            </p>
                          </div>
                          <div className="bg-white rounded-lg p-4 border border-teal-200">
                            <h4 className="font-semibold text-gray-800 mb-2">
                            ...
                            <p className="text-gray-700">
                              UTIITSL certification upon completion
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-200">
                        ...
                        <div className="space-y-4">
                          <div className="bg-white rounded-lg p-4 border border-indigo-200">
                            ...
                            <p className="text-gray-700">
                              UTIITSL technical support team
                            </p>
                          </div>
                          <div className="bg-white rounded-lg p-4 border border-indigo-200">
                            <h4 className="font-semibold text-gray-800 mb-2">
                          ...
                          <div className="bg-white rounded-lg p-4 border border-indigo-200">
                            ...
                            <p className="text-gray-700">
                              UTIITSL partnership benefits and support
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-xl border border-purple-200">
                    ...
                    <div className="space-y-6">
                      {faq.map((faq, index) => (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ duration: 0.6, delay: index * 0.1 }}
                          className="bg-gradient-to-r from-green-50 to-teal-50 rounded-xl p-6 border border-green-200 hover:shadow-lg transition-all duration-300"
                        >
                    ...
                    <div className="mt-8 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <button className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg">
                          <Phone className="w-5 h-5" />
                          <span>Call Us</span>
                        </button>
                        <button className="border-2 border-purple-600 text-purple-600 px-6 py-3 rounded-xl font-semibold hover:bg-purple-600 hover:text-white transition-all duration-300 flex items-center justify-center space-x-2">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Ready to Start Your PAN Centre?
            </h2>
            <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">
              Join our network of successful PAN service providers and start
              earning while serving your community.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                // onClick={downloadForm}
                className="bg-white text-purple-600 px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-2"
              >
                <Download className="w-5 h-5" />
                <span>Download Application Form</span>
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-purple-600 transition-all duration-300 flex items-center justify-center space-x-2">
                <Phone className="w-5 h-5" />
