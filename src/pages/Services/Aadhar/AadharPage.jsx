            ...
            <div>
              ...
              >
                <button
                  ...
                  className="bg-white text-green-600 px-6 py-3 cursor-pointer rounded-xl font-semibold hover:bg-green-50 transition-colors flex items-center justify-center space-x-2 shadow-lg"
                >
                  <Download className="w-5 h-5" />
                  <span>Download Application Form</span>
                </button>
                <a href={`tel:+91${import.meta.env.VITE_MOBILE_NO_1}`}>
                  <button className="border-2 border-white text-white px-6 py-3 cursor-pointer rounded-xl font-semibold hover:bg-white hover:text-green-600 transition-colors flex items-center justify-center space-x-2">
